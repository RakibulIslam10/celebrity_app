...
import '../../widgets/others/payment_success_screen.dart';

class MeetupPaymentScreen extends StatelessWidget {
  const MeetupPaymentScreen({super.key});
      ...
      child: Column(
        children: [
          CustomButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, '/paymentSuccessMeetupScreen');
              }),
          verticalSpace(Dimensions.heightSize),
          Row(
            children: [
